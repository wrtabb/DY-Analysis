...
//File Names
const TString fileName= "/home/hep/wrtabb/git/DY-Analysis/data/unfolding/phase2/unfIn.root";       
const bool backInc = false;
void testTUnfold()
{
  ///////////////////////////////////////
  ...
  TString saveName = "/home/hep/wrtabb/git/DY-Analysis/plots/unfolding/phase2/";
  
  if(regType == NO_REG) saveName+="unfPhase2_NoReg.png";
  if(regType == VAR_REG) saveName+="unfPhase2_VarReg.png";
  canvas1->SaveAs(saveName);

  TFile*fileSave = new TFile("/home/hep/wrtabb/git/DY-Analysis/data/unfolding/phase2/unfOut.root","recreate");
  fileSave->cd();
  hRecoRebin->Write();
  hReco->Write();
  hGen->Write();
