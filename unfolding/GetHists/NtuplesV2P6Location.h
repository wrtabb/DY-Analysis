...
const TString WJets_ext =    base + "WJetsToLNu_amcatnlo_ext/";
const TString WJets_ext2v5 = base + "WJetsToLNu_amcatnlo_ext2v5/";

//-----tops-----//
const TString ST_tW =               base + "ST_tW/";
const TString ST_tbarW =            base + "ST_tbarW/";
const TString ttbar =               base + "ttbar/";
const TString ttbarBackup =         base + "ttbarBackup/";
...
const TString DoubleEG_RunHver2 = base + "crab_DoubleEG_RunHver2/";
const TString DoubleEG_RunHver3 = base + "crab_DoubleEG_RunHver3/";
...
const TString SM_2016Hver2 = base + "SingleMuon_Run2016Hver2/";
const TString SM_2016Hver3 = base + "SingleMuon_Run2016Hver3/";
